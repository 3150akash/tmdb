...
const Moviecard = ({ currentItem, size }) => {
    ...
    return (
        ...
        // <div className={(size === "large") ? "col-3 p-0 border " : "col-2 p-0 border "} style={{ borderRadius: ".8rem" }}>
        //     <div style={{ borderRadius: ".8rem" }} className="border" top width="100%" src={`https://image.tmdb.org/t/p/w220_and_h330_face${currentItem.poster_path ? currentItem.poster_path : currentItem.profile_path}`} alt="Card image cap" />
        //     <div className="pb-0">
        //         <div title={cardTitle}><h4>{cardTitle.length > 15 ? cardTitle.substring(0, 15) + "..." : cardTitle}</h4></div>
        //         {
        //             currentItem.title
        //                 ? <div><h5 style={{ color: "gray" }}>{currentItem.release_date ? currentItem.release_date : currentItem.first_air_date}</h5></div>
        //                 : null
        //         }
        //     </div>
        // </div>
